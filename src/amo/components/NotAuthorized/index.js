...
export class NotFoundBase extends React.Component {
  ...
  render() {
    ...
    const fileAnIssueText = i18n.gettext(oneLine`
      ...
      <a href="https://github.com/mozilla/addons-frontend/issues/new/">file
      an issue</a>. Tell us where you came from and what you were trying to
      access, and we'll fix the issue.`);
